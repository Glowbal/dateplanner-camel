...
import nl.han.dare2date.DatePlannerRequest;
import nl.han.dare2date.DatePlannerResponse;
import nl.han.dare2date.PlaceType;
import nl.han.dare2date.service.business.DateTaskService;
import nl.han.dare2date.service.business.DateTaskFactory;
import nl.han.dare2date.service.business.IDateTaskService;
...
public class ApplyRegistrationRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("file://inbox")
                .from("spring-ws:rootqname:{http://www.han.nl/schemas/dateplanner}DatePlannerRequest?endpointMapping=#applyRegistrationEndpointMapping")
                    .unmarshal(jaxb).
                            log("${body}").
                                process(new Echo())
                                    .marshal(jaxb);
    ...
    private static final class Echo implements Processor {
        public void process(Exchange exchange) throws Exception {
            ...
            nl.han.dare2date.service.business.IDateTaskService task = new DateTaskFactory().create();
