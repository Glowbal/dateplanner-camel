...
import nl.han.dateplanner.services.application.google.GeoLocation;
import nl.han.dateplanner.services.application.google.IGeoLocationService;
import nl.han.dateplanner.services.application.google.IPlacesService;
...
import nl.han.dateplanner.services.application.openweather.IWeatherService;
...
public class DateFinderService implements IDateFinderService {
    ...
    public List<DateOption> getDateOptions(String type, String location, String dayPart, Double radius) throws IOException {
        ...
        try {
            ...
            List<Future<List<Forecast>>> asyncForecasts = new ArrayList<Future<List<Forecast>>>();
            ...
            List<DateOption> dateOptions = new ArrayList<DateOption>();
        ...
        return new ArrayList<DateOption>();
    }

    @Async
    private Future<List<Forecast>> getForecasts(Double latitude, Double longitude, String dayPart) throws IOException {
        return new AsyncResult<List<Forecast>>(weatherService.retrieveWeather(latitude.floatValue(), longitude.floatValue(), dayPart));
    }
