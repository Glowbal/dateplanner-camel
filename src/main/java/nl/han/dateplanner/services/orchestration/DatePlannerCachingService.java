 ...
 */
public class DatePlannerCachingService extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        System.out.println("CONFIGURE ROUTE DatePlannerCachingService");
        from("activemq:datePlannerMessages")
            .unmarshal(jaxb)
                .process(new HandleNewMessage())
            .marshal(jaxb)
            .setExchangePattern(ExchangePattern.InOnly)
                .log(LoggingLevel.DEBUG, "nl.han.dateplanner.DatePlannerCachingService", "Processing ${body}")
